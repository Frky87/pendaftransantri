...
<head>
  ...
  <title>Register Admin - Pendaftaran Santri</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ asset('style/assets/img/daral1.png') }}" rel="icon">
  <link href="{{ asset('style/assets/img/daral1.png') }}" rel="apple-touch-icon">
            ...
            <div class="col-lg-12 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Pendaftaran Santri Baru</span>
                </a>
              </div><!-- End Logo -->
