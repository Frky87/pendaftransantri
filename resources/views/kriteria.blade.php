...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Kreteria Penerimaan</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Home</a></li>
          <li class="breadcrumb-item active"><a href="{{ url('profilpondok') }}">Profil Pondok</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Berikut ini adalah aturan calon santri agar diterima di pondok pesantran:</p>
                        <ul>
                            <li>Wajib dalam semua kegiatan proses penerimaan.</li>
                            <li>Memiliki Nilai Minimum Ujian 75.</li>
                            <li>Pendidikan Terakhir SD.</li>
                            <li>Membayar Biaya Penerimaan Apabila Diterima Menjadi Santri.</li>
                            <li>Setelah Diterima Menjadi Santri Maka Wali Santri Wajib Memasrahkannya Dipondok.</li>
                        </ul>
                        <p>Peraturan Tersebut Wajib Ditaati oleh semua peserta jikalau ada yang dilanggar maka terpaksa tidak akan diterima.</p>
                    </div>
                </div>
            </div>
        </div>
